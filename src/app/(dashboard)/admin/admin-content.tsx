...
export function AdminContent({ initialRows }: { initialRows: FeedbackRow[] }) {
  ...
  const openCount = initialRows.filter((r) => r.status === "open").length;
